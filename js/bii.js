...
if(biicore.bgMusic){
	...
	<div class="bii-player" style="display:none!important">
...
if(!biicore.isPremium && !biicore.templatePremium) {
	...
	<div class="bii-logo" style="display:none"><div class="bii-logo-secondary"><div class="bii-logo-secondary-content">Nền tảng tạo Website đám cưới miễn phí!</div></div><a href="${biicore.coreSite}/wedding" target="_blank"><img src="${biiLogo}" /></a></div>
	<div class="bii-footer" style="z-index:9999;background-color: #000;color: #fff;text-align: center;letter-spacing: 1px;bottom: 0;width: 100%;font-size: 13px;padding: 5px 0">
		<div class="container">
			<span>
				copyright 2023</span> | 
				<span class="show-desktop">gosu28</span>
				<span class="show-mobile">gosu28
				</span>
		</div>
	</div>
	`);
